...
class BasicAuthenticationFrontend extends AbstractBasicAuthentication implements MiddlewareInterface
{

    public function process(ServerRequestInterface $request, RequestHandlerInterface $handler): ResponseInterface
    {
        if ($this->extensionConfiguration->isFrontendEnabled()) {
            if (!$this->validationService->validate('frontend', $request)) {
